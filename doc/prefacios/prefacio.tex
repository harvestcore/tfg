...
\noindent{\textbf{Palabras clave}: servicios, infraestructura, aprovisionamiento, backend, frontend, API REST}\\
...
\noindent{\textbf{Keywords}: services, infrastructure, provisioning, backend, frontend, API REST}\\
